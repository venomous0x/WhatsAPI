...
include("decode.php");
 ...
 class WhatsApp {
	...
	var $_server = 's.whatsapp.net';
	var $_host = 'bin-short.whatsapp.net';
	var $_Digest_Uri = 'xmpp/s.whatsapp.net';
	var $_Realm = 's.whatsapp.net';
	var $_Qop = 'auth';
	var $_contype = 'STREAM_CLIENT_PERSISTENT';
	/*
	Account Info
	*/
	var $_account_status = '';	// Active or not .. 
	var $_account_kind = '';	// paid or free .. 
	var $_account_creation = '';	// Timestamp of creation date
	var $_account_expiration = '';	// Timestamp of expiration date
	...
	function Login()
	{
		$Data = "WA"."\x01\x00\x00\x19\xf8\x05\x01\xa0\x8a\x84\xfc\x11"."iPhone-2.6.7-5222".
 ...
 $What1 = new WhatsApp( "full number without + or 00", "password");
 $What1->Connect();
 $What1->Login();
...
$What1->sendImage(time()."-1","973xxxxxx","ccf7b9444a511639efd998260b712253.jpg","9999",$link,$b64thumb);
 ////// END SEND FILE TEST
...
$What1 -> Message(time()."-1","97366666666","$bbcode");
 //$What1->RequestLastSeen("9733110772"); 
 ?>